	...
	<body>
		...
		<div class="container">
					...
					<table class="table table-bordered">
						<tbody>
							...
							<tr class="active">
								...
								<td width="30%">
									<a target="_blank" href="${pageContext.request.contextPath }/product?method=getProductById&pid=${item.product.pid}"> ${item.product.pname }</a>
								</td>
								<td width="20%">
			...
			<c:if test="${order.state==0 }">
				<div>
					<hr/>
					<form id="orderForm" action="${pageContext.request.contextPath }/order" class="form-horizontal" style="margin-top:5px;margin-left:150px;">
