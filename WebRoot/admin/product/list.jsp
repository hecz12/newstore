						...
						<td class="ta_01" align="center" bgColor="#f5fafe">
							<table cellspacing="0" cellpadding="1" rules="all"
								...
								<tr
									...
									<td width="7%" align="center">
										<c:if test="${flag==1 }">上架</c:if>
										<c:if test="${flag==0 }">下架</c:if>
								...
								<c:forEach items="${list }" var="p" varStatus="vs">
										<tr onmouseover="this.style.backgroundColor = 'white'"
											...
											<td align="center" style="HEIGHT: 22px">
												<a href="${ pageContext.request.contextPath }/adminProductServlet?method=updateUI&pid=${p.pid}">
													<img src="${pageContext.request.contextPath}/images/i_edit.gif" border="0" style="CURSOR: hand">
												</a>
											</td>
											<c:if test="${flag==1 }">
												<td align="center" style="HEIGHT: 22px">		
													<a href="${pageContext.request.contextPath }/adminProductServlet?method=under&pid=${p.pid}">
